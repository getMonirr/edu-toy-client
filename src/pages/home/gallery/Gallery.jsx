  ...
  return (
    <div className="bg-[#EEDFE4]">
      <div className="container mx-auto py-32">
        ...
        <LightGallery
          elementClassNames="grid grid-cols-3 gap-8 grid-flow-row-dense"
          onInit={onInit}
          speed={500}
        ...
        >
          <a className="grid-flow-row-dense" href={cube}>
            <img
              className="object-fill object-center w-full p-1 bg-edu-nav grayscale hover:grayscale-0 transition"
              alt="img1"
              src={cube}
            />
          </a>
